...
Local::Local(int _prix, int _m2, int _ref_client, float _taille_vitrine, bool _espace_stockage) : Bien(_prix, _m2,
                                                                                                       _ref_client) {
    taille_vitrine = _taille_vitrine;
    espace_stockage = _espace_stockage;
}

Local::Local(Adresse _adresse, int _prix, int _m2, int _ref_client, float _taille_vitrine, bool _espace_stockage)
        : Bien(_adresse, _prix, _m2,
               _ref_client) {
    taille_vitrine = _taille_vitrine;
    espace_stockage = _espace_stockage;
}
